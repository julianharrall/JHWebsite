...
function isItTime() {
    var now = new Date();
    return ((now.getMonth() == xmasFools.month && now.getDate() == xmasFools.date) ||
        (now.getMonth() == autumnleaf.month && now.getDate() == autumnleaf.date) ||
        (now.getMonth() == starFall.month && now.getDate() == starFall.date))
}
...
function isItAutumn() {
    var now = new Date();
    return (now.getMonth() == autumnleaf.month && now.getDate() == autumnleaf.date);
}

function isItStar() {
    var now = new Date();
    return (now.getMonth() == starFall.month && now.getDate() == starFall.date);
}
...
if (isItTime()) {
    ...
    if (isItStar()) {
        var image = "./star.png";  //Image path should be given here
        no = 25;
    }
    

    if (isItxmas()) {
        var image = "./snow.gif";  //Image path should be given here
    }
