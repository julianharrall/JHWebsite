<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoughTech.aspx.cs" Inherits="JMSHWebsite.LoughTech" %>
...
<body>
    ...
    <div>
        <img src="/images/loughboroug2.JPG" alt="Mountain View" <%--style="width:280px;height:150px--%>"/>
    </div>
...
<p class="glidetext">    A Level Physics Grade </p> <%--<img src="images/01.jpg" alt=""/>--%>
             

<p class="glidetext">    A Level Human Biology Grade </p>
            
             
<p class="glidetext">    A Level Pure Maths Grade </p>
         
         </div> 
    </div>

    <div id="WorkSummaryLoughborough">  
     ...
     <p class="tooltiptext" style="top:90px; left:-110px;">Loughborough College <br />Radmoor Rd<br />
                            Loughborough<br />
                            Leicestershire<br />
                            LE11 3BT</p>
</div>
