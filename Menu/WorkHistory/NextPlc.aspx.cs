...
namespace KPWebsite
{
    public partial class NextPlc : System.Web.UI.Page
    {
        ...
        {
            PieXValues = ConfigurationManager.AppSettings["PieXvaluesNext"];
            PieYValues = ConfigurationManager.AppSettings["PieYvaluesNext"];
        ...
        public string PieChartText(string val)
        {
            ...
            switch (val)
            {
                case "Problem Solving":
                    return System.Environment.NewLine + "Debugging an application to establish a fix." +
                    System.Environment.NewLine + "Building and releasing the module. ";

                case "Communication":
                    return System.Environment.NewLine + "Building relationships in a team environment. " +
                    System.Environment.NewLine + "Being able establish a rapport with external customers";
                    
                case "Planning":
                    return System.Environment.NewLine + "Interpreting project specifications " +
                     System.Environment.NewLine + "Creating a project plan with a timeline.";

                case "Technical":
                    return System.Environment.NewLine + "Analyse and deliver information from specifications" +                   
